...
#     Launches docker container from public.ecr.aws/sam/build-pythonX.X image
#         where X.X is the python version (3.9) - defaults to 3.9
...
usage() {
  ...
  echo -e "     -p PYTHON_VER\t: Python version to use: 3.9 (default 3.9)"
  echo -e "     -h\t\t\t: help"
